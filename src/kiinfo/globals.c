...
{"mbind", "ret", HEX, "*addr", HEX, "len", DECIMAL, "mode", HEX, "*nodemask", HEX, "maxnode", DECIMAL, "flags", HEX},
...
{"openat", "ret", DECIMAL, "dirfd", DECIMAL, "*pathname", HEX, "flags", HEX, "mode", OCTAL, NULL, SKIP, NULL, SKIP},
...
{"ukn-334", "ret", HEX, NULL, SKIP, NULL, SKIP, NULL, SKIP, NULL, SKIP, NULL, SKIP, NULL, SKIP},
