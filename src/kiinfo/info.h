...
extern void 	sleep_report(void *, void *, int (*funct)(const void *, const void *), FILE *);
...
extern int      print_wait_info(void *, void *);
...
extern int    print_docker_summary(void *, void *);
...
extern int    ki_ioctl(void *, void *, uint64);
...
extern int    ki_splice(void *, void *, uint64);
...
extern int    clear_wwn_iostats(void *, void *);
...
extern int    print_pid_iototals(void *, void *);
...
extern int	pid_printf(FILE *, const char *, ...); 
extern int	dock_printf(const char *, ...); 
extern int	csv_printf(FILE *, const char *, ...); 
extern int	json_printf(FILE *, const char *, ...);
extern void     wtree_build(pid_info_t *, FILE *);
extern FILE	*open_csv_file(char *, int);
extern void	close_csv_file(FILE *);
extern uint64 convert_pc_to_key(uint64, void *, uint64);
...
extern char	*get_ioctl_name(uint64);
