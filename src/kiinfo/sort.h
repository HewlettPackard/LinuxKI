...
extern int pid_sort_by_spinlock_cnt(const void *, const void *);
...
extern int ora_wait_sort_by_time(const void *, const void *);
extern int ora_wait_sort_by_count(const void *, const void *);
...
extern int spin_sort_by_count(const void *, const void *);
...
extern int fobj_sort_by_logio(const void *, const void *);
extern int fobj_sort_by_physio(const void *, const void *);
extern int fdev_sort_by_physio(const void *, const void *);
