...
@echo ** runki for Windows $Date: 2022/05/26 $Revision: 7.4	 **
...
@echo ** runki for Windows $Date: 2021/11/09 $Revision: 7.4 ** >ki.err.%tag%
...
if exist "./GetSQLServerInfo.ps1" ( 
	@echo Collecting SQL Instance information.   Please wait 1-2 minutes per SQL Instance ....
...
del *.%tag% ki.%tag%.etl *%tag%.txt *%tag%.csv
...
@echo ** Please manually ZIP the *%tag%* files into a .zip file for analysis with LinuxKI
